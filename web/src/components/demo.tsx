...
// NOTE on assets: `mediaSrc`/`bgImageSrc` point at Unsplash's stable
// `images.unsplash.com/photo-<id>` CDN and a well-known public domain
// sample video (Google's "Big Buck Bunny" test clip) since Unsplash does
// not host video. This sandbox's network policy blocks outbound requests
// to image/video CDNs, so these could not be fetched to confirm from here
// — verify they render when you run `npm run dev`, and swap the URLs
// below if any have gone stale.
const sampleMediaContent: MediaContentCollection = {
  ...
  image: {
    src: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=1280&auto=format&fit=crop",
    background:
      "https://images.unsplash.com/photo-1533106497176-45ae19e68ba2?q=80&w=1920&auto=format&fit=crop",
