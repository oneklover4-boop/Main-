...
export default function GlyphPortal({
  ...
  const characters = Array.from(text, (char) => {
    ...
    // A local counter closed over within this single synchronous render
    // pass (computing UTF-16 offsets per character) — not persisted state,
    // despite the rule's "after render completes" framing.
