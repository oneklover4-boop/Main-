...
export function AuroraBeam({ className, showBeamMask = true, ...props }: AuroraBeamProps) {
  return (
    ...
    >
      <div
        className={cn(
          "animate-aurora absolute -inset-[10px] [background-image:var(--white-gradient),var(--aurora)] [background-size:300%,200%] [background-position:50%_50%,50%_50%] [background-attachment:fixed,fixed] opacity-[0.3] blur-[14px] invert will-change-transform",
